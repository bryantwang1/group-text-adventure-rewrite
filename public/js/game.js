...
var CombatTracker = function () {
  function CombatTracker(trackedPlayer, otherObject) {
    _classCallCheck(this, CombatTracker);

    this.player = trackedPlayer;
    this.opponent = otherObject || {};
  }

  _createClass(CombatTracker, [{
    key: "takeDamage",
    value: function takeDamage(target, damageAmount) {
    ...
    key: "healTarget",
    value: function healTarget(target, healAmount) {
      target.previousHealth = target.currentHealth;
...
var Environment = function () {
  ...
  _createClass(Environment, [{
    key: "recordTiles",
    value: function recordTiles(currentMap) {
...
var Map = function () {
  ...
  _createClass(Map, [{
    ...
    key: "createChest",
    value: function createChest(amount, room) {
    ...
    key: "createDoor",
    value: function createDoor(amount, room) {
      for (var idx = 0; idx < amount; idx++) {
    ...
    key: "createWater",
    value: function createWater(amount, room) {
      for (var idx = 0; idx < amount; idx++) {
    ...
    key: "createLava",
    value: function createLava(amount, room) {
      for (var idx = 0; idx < amount; idx++) {
    ...
    key: "createSpike",
    value: function createSpike(amount, room) {
      for (var idx = 0; idx < amount; idx++) {
    ...
    key: "createFirepit",
    value: function createFirepit(amount, room) {
      for (var idx = 0; idx < amount; idx++) {
    ...
    key: "createObjectSwitch",
    value: function createObjectSwitch(amount, room) {
      for (var idx = 0; idx < amount; idx++) {
    ...
    key: "createPlacedMonster",
    value: function createPlacedMonster(type, room) {
...
var Player = function () {
  ...
  _createClass(Player, [{
    ...
    key: "calculateDamage",
    value: function calculateDamage() {
    ...
    key: "checkTorch",
    value: function checkTorch() {
      var torchType = "none";
      for (var idx = 0; idx < this.items.length; idx++) {
        if (this.items[idx].name !== "torch" && this.items[idx].name !== "unlitTorch") {} else if (this.items[idx].name === "torch") {
          torchType = "lit";
    ...
    key: "revive",
    value: function revive(currentMap) {
    ...
    key: "equipWeapon",
    value: function equipWeapon(weaponString) {
      ...
      for (var idx = 0; idx < this.weapons.length; idx++) {
        ...
        if (this.equippedWeapon.name === weaponString) {
          ...
          if (this.weapons[idx].name === weaponString) {
            ...
            if (this.weapons[idx].name === "bare hands") {} else if (this.weapons[idx].name === "wood sword") {
...
var _tile = require('./js/tile.object');
...
var _player = require('./js/player.object');

var _player2 = _interopRequireDefault(_player);

var _environment = require('./js/environment.object');

var _environment2 = _interopRequireDefault(_environment);

var _combatTracker = require('./js/combatTracker.object');

var _combatTracker2 = _interopRequireDefault(_combatTracker);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

},{"./js/combatTracker.object":1,"./js/environment.object":2,"./js/gameContainer":3,"./js/map.object":4,"./js/player.object":5,"./js/tile.object":6,"jquery":8}],8:[function(require,module,exports){
/*!
