...
var Environment = function () {
  ...
  _createClass(Environment, [{
    ...
    value: function updateCommands() {
      ...
      try {
        for (var _iterator = this.surroundings[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
    ...
    key: "useObject",
    value: function useObject(player) {

      var y = player.y - 1;
      var x = player.x - 1;
      var whichTorch = player.checkTorch();
      ...
      objectLoopBreaker: {
        ...
        try {
          for (var _iterator2 = this.surroundings[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
            ...
            if (tile.terrainType === "firepit") {
              switch (whichTorch) {
                ...
                case 'unlit':
                  ...
                  try {
                    for (var _iterator3 = player.items[Symbol.iterator](), _step3; !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {
